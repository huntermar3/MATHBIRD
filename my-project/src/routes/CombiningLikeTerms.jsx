...
function CombiningLikeTerms(){
    return(
        ...
        <h1 className='font bold text-4xl flex justify-center uppercase py-10'>Combining Like terms<LiaEarlybirds></LiaEarlybirds></h1>
...
export default CombiningLikeTerms;