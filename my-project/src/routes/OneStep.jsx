...
<div className='min-h-screen bg-[#FA5F55] text-white font-serif'>
        ...
        <h1 className='font bold text-4xl flex justify-center uppercase py-10'>one step equations<LiaEarlybirds></LiaEarlybirds></h1>
        <div className='flex justify-center pb-7'>
            <ReactPlayer
            url = 'https://www.youtube.com/watch?v=jWpiMu5LNdg' 
            controls = {true}
            />
        </div>
    </div>
