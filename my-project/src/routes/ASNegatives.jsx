...
function ASNegatives(){
    return(
        ...
        <h1 className='font bold text-4xl flex justify-center uppercase py-10'>add & subtract negatives<LiaEarlybirds></LiaEarlybirds></h1>
        <div className='flex justify-center pb-7'>
            <ReactPlayer
            url = 'https://youtu.be/Wti6JQEabfQ' 
            controls = {true}
            />
        </div>
    </div>
