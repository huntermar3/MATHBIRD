...
function NegativeNums(){
    return(
        ...
        <h1 className='font bold text-4xl flex justify-center uppercase py-10'>Negative numbers<LiaEarlybirds></LiaEarlybirds></h1>
        <div className='flex justify-center pb-7'>
            <ReactPlayer
            url = 'https://www.youtube.com/watch?v=DBSviXhkubg' 
            controls = {true}
            />
        </div>
    </div>
