...
function Proportions(){
    return(
        ...
        <h1 className='font bold text-4xl flex justify-center uppercase py-10'>Proportions<LiaEarlybirds></LiaEarlybirds></h1>
        <div className='flex justify-center pb-7'>
            <ReactPlayer
            url = 'https://www.youtube.com/watch?v=wT8tGc-SwKk' 
            controls = {true}
            />
        </div>
    </div>
